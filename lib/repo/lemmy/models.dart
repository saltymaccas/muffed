...
class LemmyCommentReply extends Equatable {
  LemmyCommentReply({
  ...
  /// The ID of the original comment
  final int commentId;

  /// The ID of the person who replied
  final int personId;

  /// The ID of the post the comment was on
  final int postId;
  ...
  LemmyCommentReply.fromReplyViewJson(Map<String, dynamic> json)
      : commentId = json['comment']['id'],
        personId = json['reply']['person_id'],
        postId = json['reply']['post_id'],
        commentContent = json['reply']['content'],
        personName = json['reply']['person_name'],
        removed = json['reply']['removed'];
